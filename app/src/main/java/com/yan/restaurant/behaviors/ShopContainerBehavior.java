package com.yan.restaurant.behaviors;
...
import com.yan.restaurant.Views.ShopInfoContainer;
...
public class ShopContainerBehavior extends CoordinatorLayout.Behavior<ShopInfoContainer> {
	...
	private void shouldInitProperties() {
		...
		int statusBarHeight = com.yan.restaurant.utils.ViewUtils.getStatusBarHeight(mContext);
		int acBarHeight = com.yan.restaurant.utils.ViewUtils.dip2px(mContext, 56);

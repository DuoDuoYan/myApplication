...
import static com.yan.restaurant.activity.HomeActivity.CLEARCAR_ACTION;
...
public class DetailActivity extends BaseActivity implements AddWidget.OnAddClick {
	...
	private void initShopCar() {
		...
		flist.addAll(HomeActivity.carAdapter.getData());
	...
	private void dealCar(FoodBean foodBean) {
		...
		Intent intent = new Intent(HomeActivity.CAR_ACTION);
